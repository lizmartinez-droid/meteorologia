...
El paquete meteorologia permite descargar, leer, procesar y visualizar
datos meteorológicos provenientes del INTA.
...
La función leer_datos_estacion() obtiene los datos crudos
...
**Nota**: Muchas variables pueden contener valores faltantes porque no
todas las estaciones miden la misma información.
...
![](meteorologia_files/figure-html/unnamed-chunk-6-1.png)
